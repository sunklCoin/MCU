...
protected:
    ...
    /**
     * @fn virtual void HALSDL::renderLCD_FrameBufferToMemory(const Rect& rectToUpdate, uint8_t* frameBuffer);
     *
     ...
     */
    virtual void renderLCD_FrameBufferToMemory(const Rect& rectToUpdate, uint8_t* frameBuffer);
