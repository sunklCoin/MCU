...
#define LOCATION_INTFLASH_PRAGMA
#define LOCATION_INTFLASH_ATTRIBUTE
#else
#ifdef __GNUC__
#ifdef __CODE_RED
...
#define LOCATION_INTFLASH_PRAGMA
#define LOCATION_INTFLASH_ATTRIBUTE __RODATA(PROGRAM_FLASH)
#else
#define LOCATION_INTFLASH_PRAGMA LOCATION_EXTFLASH_PRAGMA
#define LOCATION_INTFLASH_ATTRIBUTE LOCATION_EXTFLASH_ATTRIBUTE
#endif
#else
#define LOCATION_EXTFLASH_PRAGMA
...
#if GUI_RESOURCE_ONLY_INTERNAL_FLASH == 1
#define FONT_LOCATION_FLASH_PRAGMA
#define FONT_LOCATION_FLASH_ATTRIBUTE __RODATA(PROGRAM_FLASH)
#else
#define FONT_LOCATION_FLASH_PRAGMA
...
#if GUI_RESOURCE_ONLY_INTERNAL_FLASH == 1
#define TEXT_LOCATION_FLASH_PRAGMA
#define TEXT_LOCATION_FLASH_ATTRIBUTE __RODATA(PROGRAM_FLASH)
#else
#define TEXT_LOCATION_FLASH_PRAGMA
