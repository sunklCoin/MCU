...
#ifndef HORIZONTAL_WHEEL_HPP
#define HORIZONTAL_WHEEL_HPP
...
/**
* @class HorizontalWheelSelector HorizontalWheelSelector.hpp gui/custom_controls_screen/HorizontalWheelSelector.hpp
*
...
* @sa Container
*/
class HorizontalWheelSelector : public Container
{
    public:
    /**
    ...
    *        Destructor.
    */
    virtual ~HorizontalWheelSelector();
    ...
    */
    ...
    void setElementSelectedCallback(touchgfx::GenericCallback<const HorizontalWheelSelector&, const int&>& callback)
    {
    ...
    GenericCallback<const HorizontalWheelSelector&, const int&>* elementSelectedAction;

    Callback<HorizontalWheelSelector, const MoveAnimator<TextArea>& > textMoveEndedCallback;
