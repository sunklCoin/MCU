 ...
 *
 *****************************************************************************/
#ifndef HORIZONTAL_SLIDE_MENU_HPP_
#define HORIZONTAL_SLIDE_MENU_HPP_
...
class HorizontalSlideMenu : public Container
{
public:
    HorizontalSlideMenu();
    virtual ~HorizontalSlideMenu();
    ...
    void setElementSelectedCallback(touchgfx::GenericCallback<const HorizontalSlideMenu&>& callback)
    {
...
private:
    ...
    GenericCallback<const HorizontalSlideMenu&>* elementSelectedAction;
    ...
    Callback<HorizontalSlideMenu, const ZoomAnimationImage&> animationEndedCallback;
    void animationEndedHandler(const ZoomAnimationImage& image);
    bool animating();
};

#endif /* HORIZONTAL_SLIDE_MENU_HPP_ */
