...
public:
    ...
    {
#ifdef SIMULATOR
    extern ModelListener* gSM_ModelListener;
    gSM_ModelListener = listener;
#endif
    ...
    TimeUtils getCurrentTime() const
    {
        return mTimeUtils;
    }
...
protected:
    ...
    uint16_t m_tick_count_down;
    uint8_t m_program_seconds_left;
    #ifdef SIMULATOR
