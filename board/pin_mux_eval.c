...
pin_labels:
- {pin_num: P10, pin_signal: PIO2_17/LCD_CLKIN/USB1_UP_LED/USB1_OVERCURRENTN/CTIMER1_CAP1/FC8_RXD_SDA_MOSI, label: BLE wake up pin}
- {pin_num: P14, pin_signal: PIO3_27/SCT0_OUT1/FC4_TXD_SCL_MISO/EMC_A(16), label: BLE uart tx}
- {pin_num: K5, pin_signal: PIO3_26/SCT0_OUT0/FC4_RXD_SDA_MOSI/EMC_A(15), label: BLE uart rx}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */

#include "fsl_common.h"
#include "pin_mux_eval.h"
...
#define PIO211_FUNC_ALT0              0x00u   /*!< Selects pin function.: Alternative connection 0. */
...
#define PIO331_DIGIMODE_DIGITAL       0x01u   /*!< Select Analog/Digital mode.: Digital mode. */
#define PIO331_FUNC_ALT0              0x00u   /*!< Selects pin function.: Alternative connection 0. */
...
- pin_list:
  ...
  - {pin_num: J14, peripheral: GPIO, signal: 'PIO3, 31', pin_signal: PIO3_31/FC9_RTS_SCL_SSEL1/SCT0_OUT5/CTIMER4_MAT2/SCT0_GPI0/EMC_A(20)}
  - {pin_num: K3, peripheral: GPIO, signal: 'PIO2, 11', pin_signal: PIO2_11/LCD_PWR/SD_VOLT(0)/FC5_SCK}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitLCDPins(void) { /* Function assigned for the Core #0 (ARM Cortex-M4) */
  ...
  IOCON->PIO[2][11] = ((IOCON->PIO[2][11] &
    (~(IOCON_PIO_FUNC_MASK | IOCON_PIO_DIGIMODE_MASK)))      /* Mask bits to zero which are setting */
      | IOCON_PIO_FUNC(PIO211_FUNC_ALT0)                     /* Selects pin function.: PORT211 (pin K3) is configured as PIO2_11 */
  ...
  IOCON->PIO[3][31] = ((IOCON->PIO[3][31] &
    (~(IOCON_PIO_FUNC_MASK | IOCON_PIO_DIGIMODE_MASK)))      /* Mask bits to zero which are setting */
      | IOCON_PIO_FUNC(PIO331_FUNC_ALT0)                     /* Selects pin function.: PORT331 (pin J14) is configured as PIO3_31 */
      | IOCON_PIO_DIGIMODE(PIO331_DIGIMODE_DIGITAL)          /* Select Analog/Digital mode.: Digital mode. */
    );
...
#define PIO226_FUNC_ALT0              0x00u   /*!< Selects pin function.: Alternative connection 0. */
...
void BOARD_InitIrDAPins(void) { /* Function assigned for the Core #0 (ARM Cortex-M4) */
  ...
  IOCON->PIO[0][29] = ((IOCON->PIO[0][29] &
    (~(IOCON_PIO_FUNC_MASK | IOCON_PIO_DIGIMODE_MASK)))      /* Mask bits to zero which are setting */
      | IOCON_PIO_FUNC(PIO029_FUNC_ALT1)                     /* Selects pin function.: PORT029 (pin B13) is configured as FC0_RXD_SDA_MOSI */
      | IOCON_PIO_DIGIMODE(PIO029_DIGIMODE_DIGITAL)          /* Select Analog/Digital mode.: Digital mode. */
    );
  IOCON->PIO[0][30] = ((IOCON->PIO[0][30] &
    (~(IOCON_PIO_FUNC_MASK | IOCON_PIO_DIGIMODE_MASK)))      /* Mask bits to zero which are setting */
      | IOCON_PIO_FUNC(PIO030_FUNC_ALT1)                     /* Selects pin function.: PORT030 (pin A2) is configured as FC0_TXD_SCL_MISO */
      | IOCON_PIO_DIGIMODE(PIO030_DIGIMODE_DIGITAL)          /* Select Analog/Digital mode.: Digital mode. */
    );
  IOCON->PIO[2][26] = ((IOCON->PIO[2][26] &
    (~(IOCON_PIO_FUNC_MASK | IOCON_PIO_DIGIMODE_MASK)))      /* Mask bits to zero which are setting */
      | IOCON_PIO_FUNC(PIO226_FUNC_ALT0)                     /* Selects pin function.: PORT226 (pin H11) is configured as PIO2_26 */
...
- options: {callFromInitBoot: 'true', coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: A1, peripheral: GPIO, signal: 'PIO0, 1', pin_signal: PIO0_1/CAN1_TD/FC3_CTS_SDA_SSEL0/CTIMER0_CAP0/SCT0_GPI1/PDM0_DATA, identifier: ''}
...
#define PIO016_DIGIMODE_ANALOG        0x00u   /*!< Select Analog/Digital mode.: Analog mode. */
...
void BOARD_InitChargePins(void) { /* Function assigned for the Core #0 (ARM Cortex-M4) */
  ...
  IOCON->PIO[0][16] = ((IOCON->PIO[0][16] &
    (~(IOCON_PIO_FUNC_MASK | IOCON_PIO_DIGIMODE_MASK)))      /* Mask bits to zero which are setting */
      | IOCON_PIO_FUNC(PIO016_FUNC_ALT0)                     /* Selects pin function.: PORT016 (pin M4) is configured as ADC0_4 */
      | IOCON_PIO_DIGIMODE(PIO016_DIGIMODE_ANALOG)           /* Select Analog/Digital mode.: Analog mode. */
    );
...
#define PIO217_DIGIMODE_DIGITAL       0x01u   /*!< Select Analog/Digital mode.: Digital mode. */
#define PIO217_FUNC_ALT0              0x00u   /*!< Selects pin function.: Alternative connection 0. */
#define PIO326_DIGIMODE_DIGITAL       0x01u   /*!< Select Analog/Digital mode.: Digital mode. */
#define PIO326_FUNC_ALT3              0x03u   /*!< Selects pin function.: Alternative connection 3. */
#define PIO327_DIGIMODE_DIGITAL       0x01u   /*!< Select Analog/Digital mode.: Digital mode. */
#define PIO327_FUNC_ALT3              0x03u   /*!< Selects pin function.: Alternative connection 3. */
...
- pin_list:
  ...
  - {pin_num: P10, peripheral: GPIO, signal: 'PIO2, 17', pin_signal: PIO2_17/LCD_CLKIN/USB1_UP_LED/USB1_OVERCURRENTN/CTIMER1_CAP1/FC8_RXD_SDA_MOSI}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitBlePins(void) { /* Function assigned for the Core #0 (ARM Cortex-M4) */
  ...
  IOCON->PIO[2][17] = ((IOCON->PIO[2][17] &
    (~(IOCON_PIO_FUNC_MASK | IOCON_PIO_DIGIMODE_MASK)))      /* Mask bits to zero which are setting */
      | IOCON_PIO_FUNC(PIO217_FUNC_ALT0)                     /* Selects pin function.: PORT217 (pin P10) is configured as PIO2_17 */
      | IOCON_PIO_DIGIMODE(PIO217_DIGIMODE_DIGITAL)          /* Select Analog/Digital mode.: Digital mode. */
    );
  IOCON->PIO[3][26] = ((IOCON->PIO[3][26] &
    (~(IOCON_PIO_FUNC_MASK | IOCON_PIO_DIGIMODE_MASK)))      /* Mask bits to zero which are setting */
      | IOCON_PIO_FUNC(PIO326_FUNC_ALT3)                     /* Selects pin function.: PORT326 (pin K5) is configured as FC4_RXD_SDA_MOSI */
      | IOCON_PIO_DIGIMODE(PIO326_DIGIMODE_DIGITAL)          /* Select Analog/Digital mode.: Digital mode. */
    );
  IOCON->PIO[3][27] = ((IOCON->PIO[3][27] &
    (~(IOCON_PIO_FUNC_MASK | IOCON_PIO_DIGIMODE_MASK)))      /* Mask bits to zero which are setting */
      | IOCON_PIO_FUNC(PIO327_FUNC_ALT3)                     /* Selects pin function.: PORT327 (pin P14) is configured as FC4_TXD_SCL_MISO */
