...
/* EMC_CKE(1) (coord P11), U28[F3]/P1_22-EMC_CKE1 */
#define BOARD_INITSDRAMPINS_EMC_CKE1_PERIPHERAL                              EMC   /*!< Device name: EMC */
#define BOARD_INITSDRAMPINS_EMC_CKE1_SIGNAL                              EMC_CKE   /*!< EMC signal: EMC_CKE */
#define BOARD_INITSDRAMPINS_EMC_CKE1_CHANNEL                                   1   /*!< EMC EMC_CKE channel: 1 */
#define BOARD_INITSDRAMPINS_EMC_CKE1_PIN_NAME                         EMC_CKE(1)   /*!< Pin name */
#define BOARD_INITSDRAMPINS_EMC_CKE1_LABEL              "U28[F3]/P1_22-EMC_CKE1"   /*!< Label */
#define BOARD_INITSDRAMPINS_EMC_CKE1_NAME                             "EMC_CKE1"   /*!< Identifier name */
...
/* SWO (coord P2), Battery Temperature detect */
...
#define BOARD_INITSWDPINS_SWO_TRGT_LABEL            "Battery Temperature detect"   /*!< Label */
...
/* LCD_PWR (coord K3), J16[31]/P2_11-LCD_PWR */
#define BOARD_INITLCDPINS_LCD_PWR_PERIPHERAL                                 LCD   /*!< Device name: LCD */
#define BOARD_INITLCDPINS_LCD_PWR_SIGNAL                                 LCD_PWR   /*!< LCD signal: LCD_PWR */
#define BOARD_INITLCDPINS_LCD_PWR_PIN_NAME                               LCD_PWR   /*!< Pin name */
...
/* PIO3_3 (coord A13), LCD WR pin */
#define BOARD_INITLCDPINS_LCD_WR_GPIO                                       GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITLCDPINS_LCD_WR_PORT                                         3U   /*!< PORT device index: 3 */
#define BOARD_INITLCDPINS_LCD_WR_GPIO_PIN                                     3U   /*!< PIO3 pin index: 3 */
#define BOARD_INITLCDPINS_LCD_WR_PIN_NAME                                 PIO3_3   /*!< Pin name */
#define BOARD_INITLCDPINS_LCD_WR_LABEL                              "LCD WR pin"   /*!< Label */
#define BOARD_INITLCDPINS_LCD_WR_NAME                                   "LCD_WR"   /*!< Identifier name */

/* FC9_SCK (coord N2), LCD SPI clock pin */
#define BOARD_INITLCDPINS_LCD_SPI_CLK_PERIPHERAL                       FLEXCOMM9   /*!< Device name: FLEXCOMM9 */
#define BOARD_INITLCDPINS_LCD_SPI_CLK_SIGNAL                                 SCK   /*!< FLEXCOMM9 signal: SCK */
#define BOARD_INITLCDPINS_LCD_SPI_CLK_PIN_NAME                           FC9_SCK   /*!< Pin name */
#define BOARD_INITLCDPINS_LCD_SPI_CLK_LABEL                  "LCD SPI clock pin"   /*!< Label */
#define BOARD_INITLCDPINS_LCD_SPI_CLK_NAME                         "LCD_SPI_CLK"   /*!< Identifier name */

/* FC9_RXD_SDA_MOSI (coord P5), LCD SPI MOSI pin */
#define BOARD_INITLCDPINS_LCD_SPI_MOSI_PERIPHERAL                      FLEXCOMM9   /*!< Device name: FLEXCOMM9 */
#define BOARD_INITLCDPINS_LCD_SPI_MOSI_SIGNAL                       RXD_SDA_MOSI   /*!< FLEXCOMM9 signal: RXD_SDA_MOSI */
#define BOARD_INITLCDPINS_LCD_SPI_MOSI_PIN_NAME                 FC9_RXD_SDA_MOSI   /*!< Pin name */
#define BOARD_INITLCDPINS_LCD_SPI_MOSI_LABEL                  "LCD SPI MOSI pin"   /*!< Label */
#define BOARD_INITLCDPINS_LCD_SPI_MOSI_NAME                       "LCD_SPI_MOSI"   /*!< Identifier name */

/* FC9_TXD_SCL_MISO (coord N5), LCD SPI MISO pin */
#define BOARD_INITLCDPINS_LCD_SPI_MISO_PERIPHERAL                      FLEXCOMM9   /*!< Device name: FLEXCOMM9 */
#define BOARD_INITLCDPINS_LCD_SPI_MISO_SIGNAL                       TXD_SCL_MISO   /*!< FLEXCOMM9 signal: TXD_SCL_MISO */
#define BOARD_INITLCDPINS_LCD_SPI_MISO_PIN_NAME                 FC9_TXD_SCL_MISO   /*!< Pin name */
#define BOARD_INITLCDPINS_LCD_SPI_MISO_LABEL                  "LCD SPI MISO pin"   /*!< Label */
#define BOARD_INITLCDPINS_LCD_SPI_MISO_NAME                       "LCD_SPI_MISO"   /*!< Identifier name */

/* FC9_CTS_SDA_SSEL0 (coord K13), LCD SPI CS pin */
#define BOARD_INITLCDPINS_LCD_SPI_CS_PERIPHERAL                        FLEXCOMM9   /*!< Device name: FLEXCOMM9 */
#define BOARD_INITLCDPINS_LCD_SPI_CS_SIGNAL                        CTS_SDA_SSEL0   /*!< FLEXCOMM9 signal: CTS_SDA_SSEL0 */
#define BOARD_INITLCDPINS_LCD_SPI_CS_PIN_NAME                  FC9_CTS_SDA_SSEL0   /*!< Pin name */
#define BOARD_INITLCDPINS_LCD_SPI_CS_LABEL                      "LCD SPI CS pin"   /*!< Label */
#define BOARD_INITLCDPINS_LCD_SPI_CS_NAME                           "LCD_SPI_CS"   /*!< Identifier name */

/* PIO4_16 (coord C4), LCD reset pin */
#define BOARD_INITLCDPINS_LCD_RST_GPIO                                      GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITLCDPINS_LCD_RST_PORT                                        4U   /*!< PORT device index: 4 */
#define BOARD_INITLCDPINS_LCD_RST_GPIO_PIN                                   16U   /*!< PIO4 pin index: 16 */
#define BOARD_INITLCDPINS_LCD_RST_PIN_NAME                               PIO4_16   /*!< Pin name */
#define BOARD_INITLCDPINS_LCD_RST_LABEL                          "LCD reset pin"   /*!< Label */
...
#define BOARD_INITIRDAPINS_ISP_FC3_SCK_LABEL                            "IR PMW"   /*!< Label */
...
/* PIO0_1 (coord A1), Power key */
#define BOARD_INITKEYBOARDPINS_PWR_KEY_GPIO                                 GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITKEYBOARDPINS_PWR_KEY_PORT                                   0U   /*!< PORT device index: 0 */
#define BOARD_INITKEYBOARDPINS_PWR_KEY_GPIO_PIN                               1U   /*!< PIO0 pin index: 1 */
#define BOARD_INITKEYBOARDPINS_PWR_KEY_PIN_NAME                           PIO0_1   /*!< Pin name */
#define BOARD_INITKEYBOARDPINS_PWR_KEY_LABEL                         "Power key"   /*!< Label */
#define BOARD_INITKEYBOARDPINS_PWR_KEY_NAME                            "PWR_KEY"   /*!< Identifier name */

/* PIO0_22 (coord B12), Keyboard int pin */
#define BOARD_INITKEYBOARDPINS_KB_INT_GPIO                                  GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITKEYBOARDPINS_KB_INT_PORT                                    0U   /*!< PORT device index: 0 */
#define BOARD_INITKEYBOARDPINS_KB_INT_GPIO_PIN                               22U   /*!< PIO0 pin index: 22 */
#define BOARD_INITKEYBOARDPINS_KB_INT_PIN_NAME                           PIO0_22   /*!< Pin name */
#define BOARD_INITKEYBOARDPINS_KB_INT_LABEL                   "Keyboard int pin"   /*!< Label */
#define BOARD_INITKEYBOARDPINS_KB_INT_NAME                              "KB_INT"   /*!< Identifier name */

/* PIO3_11 (coord B2), Keyboard reset pin */
#define BOARD_INITKEYBOARDPINS_KB_RST_GPIO                                  GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITKEYBOARDPINS_KB_RST_PORT                                    3U   /*!< PORT device index: 3 */
#define BOARD_INITKEYBOARDPINS_KB_RST_GPIO_PIN                               11U   /*!< PIO3 pin index: 11 */
#define BOARD_INITKEYBOARDPINS_KB_RST_PIN_NAME                           PIO3_11   /*!< Pin name */
#define BOARD_INITKEYBOARDPINS_KB_RST_LABEL                 "Keyboard reset pin"   /*!< Label */
#define BOARD_INITKEYBOARDPINS_KB_RST_NAME                              "KB_RST"   /*!< Identifier name */

/* FC6_RXD_SDA_MOSI_DATA (coord F14), U10[32]/J9[10]/P4_2-FC6_I2S_TX_DATA */
#define BOARD_INITKEYBOARDPINS_FC6_I2S_TX_DATA_PERIPHERAL              FLEXCOMM6   /*!< Device name: FLEXCOMM6 */
#define BOARD_INITKEYBOARDPINS_FC6_I2S_TX_DATA_SIGNAL          RXD_SDA_MOSI_DATA   /*!< FLEXCOMM6 signal: RXD_SDA_MOSI_DATA */
#define BOARD_INITKEYBOARDPINS_FC6_I2S_TX_DATA_PIN_NAME    FC6_RXD_SDA_MOSI_DATA   /*!< Pin name */
#define BOARD_INITKEYBOARDPINS_FC6_I2S_TX_DATA_LABEL "U10[32]/J9[10]/P4_2-FC6_I2S_TX_DATA" /*!< Label */
#define BOARD_INITKEYBOARDPINS_FC6_I2S_TX_DATA_NAME            "FC6_I2S_TX_DATA"   /*!< Identifier name */

/* FC6_TXD_SCL_MISO_WS (coord F13), U10[30]/J9[12]/P4_3-FC6_I2S_TX_WS */
#define BOARD_INITKEYBOARDPINS_FC6_I2S_TX_WS_PERIPHERAL                FLEXCOMM6   /*!< Device name: FLEXCOMM6 */
#define BOARD_INITKEYBOARDPINS_FC6_I2S_TX_WS_SIGNAL              TXD_SCL_MISO_WS   /*!< FLEXCOMM6 signal: TXD_SCL_MISO_WS */
#define BOARD_INITKEYBOARDPINS_FC6_I2S_TX_WS_PIN_NAME        FC6_TXD_SCL_MISO_WS   /*!< Pin name */
#define BOARD_INITKEYBOARDPINS_FC6_I2S_TX_WS_LABEL "U10[30]/J9[12]/P4_3-FC6_I2S_TX_WS" /*!< Label */
#define BOARD_INITKEYBOARDPINS_FC6_I2S_TX_WS_NAME                "FC6_I2S_TX_WS"   /*!< Identifier name */
...
/* PIO0_16 (coord M4), Charger enable pin */
#define BOARD_INITCHARGEPINS_CHG_EN_GPIO                                    GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITCHARGEPINS_CHG_EN_PORT                                      0U   /*!< PORT device index: 0 */
#define BOARD_INITCHARGEPINS_CHG_EN_GPIO_PIN                                 16U   /*!< PIO0 pin index: 16 */
#define BOARD_INITCHARGEPINS_CHG_EN_PIN_NAME                             PIO0_16   /*!< Pin name */
#define BOARD_INITCHARGEPINS_CHG_EN_LABEL                   "Charger enable pin"   /*!< Label */
#define BOARD_INITCHARGEPINS_CHG_EN_NAME                                "CHG_EN"   /*!< Identifier name */

/* PIO1_0 (coord N3), Charger detect pin */
#define BOARD_INITCHARGEPINS_CHG_DET_GPIO                                   GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITCHARGEPINS_CHG_DET_PORT                                     1U   /*!< PORT device index: 1 */
#define BOARD_INITCHARGEPINS_CHG_DET_GPIO_PIN                                 0U   /*!< PIO1 pin index: 0 */
#define BOARD_INITCHARGEPINS_CHG_DET_PIN_NAME                             PIO1_0   /*!< Pin name */
#define BOARD_INITCHARGEPINS_CHG_DET_LABEL                  "Charger detect pin"   /*!< Label */
#define BOARD_INITCHARGEPINS_CHG_DET_NAME                              "CHG_DET"   /*!< Identifier name */

/* PIO1_18 (coord D1), Fuel Gauge int pin */
#define BOARD_INITCHARGEPINS_FG_INT_GPIO                                    GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITCHARGEPINS_FG_INT_PORT                                      1U   /*!< PORT device index: 1 */
#define BOARD_INITCHARGEPINS_FG_INT_GPIO_PIN                                 18U   /*!< PIO1 pin index: 18 */
#define BOARD_INITCHARGEPINS_FG_INT_PIN_NAME                             PIO1_18   /*!< Pin name */
#define BOARD_INITCHARGEPINS_FG_INT_LABEL                   "Fuel Gauge int pin"   /*!< Label */
#define BOARD_INITCHARGEPINS_FG_INT_NAME                                "FG_INT"   /*!< Identifier name */
...
/* ADC0_0 (coord P2), Battery Temperature detect */
#define BOARD_INITCHARGEPINS_SWO_TRGT_PERIPHERAL                            ADC0   /*!< Device name: ADC0 */
#define BOARD_INITCHARGEPINS_SWO_TRGT_SIGNAL                                  CH   /*!< ADC0 signal: CH */
#define BOARD_INITCHARGEPINS_SWO_TRGT_CHANNEL                                  0   /*!< ADC0 channel: 0 */
#define BOARD_INITCHARGEPINS_SWO_TRGT_PIN_NAME                            ADC0_0   /*!< Pin name */
#define BOARD_INITCHARGEPINS_SWO_TRGT_LABEL         "Battery Temperature detect"   /*!< Label */
#define BOARD_INITCHARGEPINS_SWO_TRGT_NAME                            "SWO_TRGT"   /*!< Identifier name */
...
/* PIO0_17 (coord E14), WiFi chip power down pin */
#define BOARD_INITWIFIPINS_WIFI_CHIP_PWD_GPIO                               GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITWIFIPINS_WIFI_CHIP_PWD_PORT                                 0U   /*!< PORT device index: 0 */
#define BOARD_INITWIFIPINS_WIFI_CHIP_PWD_GPIO_PIN                            17U   /*!< PIO0 pin index: 17 */
#define BOARD_INITWIFIPINS_WIFI_CHIP_PWD_PIN_NAME                        PIO0_17   /*!< Pin name */
#define BOARD_INITWIFIPINS_WIFI_CHIP_PWD_LABEL        "WiFi chip power down pin"   /*!< Label */
#define BOARD_INITWIFIPINS_WIFI_CHIP_PWD_NAME                    "WIFI_CHIP_PWD"   /*!< Identifier name */

/* PIO0_29 (coord B13), WiFi int pin */
#define BOARD_INITWIFIPINS_WIFI_INT_GPIO                                    GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITWIFIPINS_WIFI_INT_PORT                                      0U   /*!< PORT device index: 0 */
#define BOARD_INITWIFIPINS_WIFI_INT_GPIO_PIN                                 29U   /*!< PIO0 pin index: 29 */
#define BOARD_INITWIFIPINS_WIFI_INT_PIN_NAME                             PIO0_29   /*!< Pin name */
#define BOARD_INITWIFIPINS_WIFI_INT_LABEL                         "WiFi int pin"   /*!< Label */
#define BOARD_INITWIFIPINS_WIFI_INT_NAME                              "WIFI_INT"   /*!< Identifier name */

/* PIO0_30 (coord A2), WiFi mode select pin */
#define BOARD_INITWIFIPINS_WIFI_HM0_GPIO                                    GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITWIFIPINS_WIFI_HM0_PORT                                      0U   /*!< PORT device index: 0 */
#define BOARD_INITWIFIPINS_WIFI_HM0_GPIO_PIN                                 30U   /*!< PIO0 pin index: 30 */
#define BOARD_INITWIFIPINS_WIFI_HM0_PIN_NAME                             PIO0_30   /*!< Pin name */
#define BOARD_INITWIFIPINS_WIFI_HM0_LABEL                 "WiFi mode select pin"   /*!< Label */
#define BOARD_INITWIFIPINS_WIFI_HM0_NAME                              "WIFI_HM0"   /*!< Identifier name */

/* FC3_RXD_SDA_MOSI (coord K12), WiFi SPI MOSI pin */
#define BOARD_INITWIFIPINS_WIFI_SPI_MOSI_PERIPHERAL                    FLEXCOMM3   /*!< Device name: FLEXCOMM3 */
#define BOARD_INITWIFIPINS_WIFI_SPI_MOSI_SIGNAL                     RXD_SDA_MOSI   /*!< FLEXCOMM3 signal: RXD_SDA_MOSI */
#define BOARD_INITWIFIPINS_WIFI_SPI_MOSI_PIN_NAME               FC3_RXD_SDA_MOSI   /*!< Pin name */
#define BOARD_INITWIFIPINS_WIFI_SPI_MOSI_LABEL               "WiFi SPI MOSI pin"   /*!< Label */
#define BOARD_INITWIFIPINS_WIFI_SPI_MOSI_NAME                    "WIFI_SPI_MOSI"   /*!< Identifier name */

/* FC3_SSEL3 (coord N14), WiFi SPI CS pin */
#define BOARD_INITWIFIPINS_WIFI_SPI_CS_PERIPHERAL                      FLEXCOMM3   /*!< Device name: FLEXCOMM3 */
#define BOARD_INITWIFIPINS_WIFI_SPI_CS_SIGNAL                              SSEL3   /*!< FLEXCOMM3 signal: SSEL3 */
#define BOARD_INITWIFIPINS_WIFI_SPI_CS_PIN_NAME                        FC3_SSEL3   /*!< Pin name */
#define BOARD_INITWIFIPINS_WIFI_SPI_CS_LABEL                   "WiFi SPI CS pin"   /*!< Label */
#define BOARD_INITWIFIPINS_WIFI_SPI_CS_NAME                        "WIFI_SPI_CS"   /*!< Identifier name */

/* FC3_TXD_SCL_MISO (coord P12), WiFi SPI MISO pin */
#define BOARD_INITWIFIPINS_WIFI_SPI_MISO_PERIPHERAL                    FLEXCOMM3   /*!< Device name: FLEXCOMM3 */
#define BOARD_INITWIFIPINS_WIFI_SPI_MISO_SIGNAL                     TXD_SCL_MISO   /*!< FLEXCOMM3 signal: TXD_SCL_MISO */
#define BOARD_INITWIFIPINS_WIFI_SPI_MISO_PIN_NAME               FC3_TXD_SCL_MISO   /*!< Pin name */
#define BOARD_INITWIFIPINS_WIFI_SPI_MISO_LABEL               "WiFi SPI MISO pin"   /*!< Label */
#define BOARD_INITWIFIPINS_WIFI_SPI_MISO_NAME                    "WIFI_SPI_MISO"   /*!< Identifier name */

/* FC3_SCK (coord H11), WiFi SPI CLK pin */
#define BOARD_INITWIFIPINS_WIFI_SPI_CLK_PERIPHERAL                     FLEXCOMM3   /*!< Device name: FLEXCOMM3 */
#define BOARD_INITWIFIPINS_WIFI_SPI_CLK_SIGNAL                               SCK   /*!< FLEXCOMM3 signal: SCK */
#define BOARD_INITWIFIPINS_WIFI_SPI_CLK_PIN_NAME                         FC3_SCK   /*!< Pin name */
#define BOARD_INITWIFIPINS_WIFI_SPI_CLK_LABEL                 "WiFi SPI CLK pin"   /*!< Label */
#define BOARD_INITWIFIPINS_WIFI_SPI_CLK_NAME                      "WIFI_SPI_CLK"   /*!< Identifier name */

/* PIO3_12 (coord L2), WiFi wake up pin */
#define BOARD_INITWIFIPINS_WIFI_WAKEUP_GPIO                                 GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITWIFIPINS_WIFI_WAKEUP_PORT                                   3U   /*!< PORT device index: 3 */
#define BOARD_INITWIFIPINS_WIFI_WAKEUP_GPIO_PIN                              12U   /*!< PIO3 pin index: 12 */
#define BOARD_INITWIFIPINS_WIFI_WAKEUP_PIN_NAME                          PIO3_12   /*!< Pin name */
#define BOARD_INITWIFIPINS_WIFI_WAKEUP_LABEL                  "WiFi wake up pin"   /*!< Label */
#define BOARD_INITWIFIPINS_WIFI_WAKEUP_NAME                        "WIFI_WAKEUP"   /*!< Identifier name */
...
/* PIO0_31 (coord M5), BLE int pin */
#define BOARD_INITBLEPINS_BT_INT_GPIO                                       GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITBLEPINS_BT_INT_PORT                                         0U   /*!< PORT device index: 0 */
#define BOARD_INITBLEPINS_BT_INT_GPIO_PIN                                    31U   /*!< PIO0 pin index: 31 */
#define BOARD_INITBLEPINS_BT_INT_PIN_NAME                                PIO0_31   /*!< Pin name */
#define BOARD_INITBLEPINS_BT_INT_LABEL                             "BLE int pin"   /*!< Label */
#define BOARD_INITBLEPINS_BT_INT_NAME                                   "BT_INT"   /*!< Identifier name */

/* PIO3_14 (coord E3), BLE wake up pin */
#define BOARD_INITBLEPINS_BT_WAKEUP_GPIO                                    GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITBLEPINS_BT_WAKEUP_PORT                                      3U   /*!< PORT device index: 3 */
#define BOARD_INITBLEPINS_BT_WAKEUP_GPIO_PIN                                 14U   /*!< PIO3 pin index: 14 */
#define BOARD_INITBLEPINS_BT_WAKEUP_PIN_NAME                             PIO3_14   /*!< Pin name */
#define BOARD_INITBLEPINS_BT_WAKEUP_LABEL                      "BLE wake up pin"   /*!< Label */
#define BOARD_INITBLEPINS_BT_WAKEUP_NAME                             "BT_WAKEUP"   /*!< Identifier name */

/* FC8_RXD_SDA_MOSI (coord E1), BLE uart rx */
#define BOARD_INITBLEPINS_BT_UART_RX_PERIPHERAL                        FLEXCOMM8   /*!< Device name: FLEXCOMM8 */
#define BOARD_INITBLEPINS_BT_UART_RX_SIGNAL                         RXD_SDA_MOSI   /*!< FLEXCOMM8 signal: RXD_SDA_MOSI */
#define BOARD_INITBLEPINS_BT_UART_RX_PIN_NAME                   FC8_RXD_SDA_MOSI   /*!< Pin name */
#define BOARD_INITBLEPINS_BT_UART_RX_LABEL                         "BLE uart rx"   /*!< Label */
#define BOARD_INITBLEPINS_BT_UART_RX_NAME                           "BT_UART_RX"   /*!< Identifier name */

/* FC8_TXD_SCL_MISO (coord K1), BLE uart tx */
#define BOARD_INITBLEPINS_BT_UART_TX_PERIPHERAL                        FLEXCOMM8   /*!< Device name: FLEXCOMM8 */
#define BOARD_INITBLEPINS_BT_UART_TX_SIGNAL                         TXD_SCL_MISO   /*!< FLEXCOMM8 signal: TXD_SCL_MISO */
#define BOARD_INITBLEPINS_BT_UART_TX_PIN_NAME                   FC8_TXD_SCL_MISO   /*!< Pin name */
#define BOARD_INITBLEPINS_BT_UART_TX_LABEL                         "BLE uart tx"   /*!< Label */
#define BOARD_INITBLEPINS_BT_UART_TX_NAME                           "BT_UART_TX"   /*!< Identifier name */

/* PIO3_19 (coord J3), BLE STA pin */
#define BOARD_INITBLEPINS_BT_STA_GPIO                                       GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITBLEPINS_BT_STA_PORT                                         3U   /*!< PORT device index: 3 */
#define BOARD_INITBLEPINS_BT_STA_GPIO_PIN                                    19U   /*!< PIO3 pin index: 19 */
#define BOARD_INITBLEPINS_BT_STA_PIN_NAME                                PIO3_19   /*!< Pin name */
#define BOARD_INITBLEPINS_BT_STA_LABEL                             "BLE STA pin"   /*!< Label */
#define BOARD_INITBLEPINS_BT_STA_NAME                                   "BT_STA"   /*!< Identifier name */

/* PIO3_26 (coord K5), BLE STA1 pin */
#define BOARD_INITBLEPINS_BT_STA1_GPIO                                      GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITBLEPINS_BT_STA1_PORT                                        3U   /*!< PORT device index: 3 */
#define BOARD_INITBLEPINS_BT_STA1_GPIO_PIN                                   26U   /*!< PIO3 pin index: 26 */
#define BOARD_INITBLEPINS_BT_STA1_PIN_NAME                               PIO3_26   /*!< Pin name */
#define BOARD_INITBLEPINS_BT_STA1_LABEL                           "BLE STA1 pin"   /*!< Label */
#define BOARD_INITBLEPINS_BT_STA1_NAME                                 "BT_STA1"   /*!< Identifier name */

/* PIO3_27 (coord P14), BLE reset pin */
#define BOARD_INITBLEPINS_BT_RST_GPIO                                       GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITBLEPINS_BT_RST_PORT                                         3U   /*!< PORT device index: 3 */
#define BOARD_INITBLEPINS_BT_RST_GPIO_PIN                                    27U   /*!< PIO3 pin index: 27 */
#define BOARD_INITBLEPINS_BT_RST_PIN_NAME                                PIO3_27   /*!< Pin name */
#define BOARD_INITBLEPINS_BT_RST_LABEL                           "BLE reset pin"   /*!< Label */
#define BOARD_INITBLEPINS_BT_RST_NAME                                   "BT_RST"   /*!< Identifier name */

/* PIO3_29 (coord L13), BLE reset1 pin */
#define BOARD_INITBLEPINS_BT_RST1_GPIO                                      GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITBLEPINS_BT_RST1_PORT                                        3U   /*!< PORT device index: 3 */
#define BOARD_INITBLEPINS_BT_RST1_GPIO_PIN                                   29U   /*!< PIO3 pin index: 29 */
#define BOARD_INITBLEPINS_BT_RST1_PIN_NAME                               PIO3_29   /*!< Pin name */
#define BOARD_INITBLEPINS_BT_RST1_LABEL                         "BLE reset1 pin"   /*!< Label */
#define BOARD_INITBLEPINS_BT_RST1_NAME                                 "BT_RST1"   /*!< Identifier name */

/* PIO3_15 (coord D2), BLE reserved */
#define BOARD_INITBLEPINS_BT_REV_GPIO                                       GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITBLEPINS_BT_REV_PORT                                         3U   /*!< PORT device index: 3 */
#define BOARD_INITBLEPINS_BT_REV_GPIO_PIN                                    15U   /*!< PIO3 pin index: 15 */
#define BOARD_INITBLEPINS_BT_REV_PIN_NAME                                PIO3_15   /*!< Pin name */
#define BOARD_INITBLEPINS_BT_REV_LABEL                            "BLE reserved"   /*!< Label */
#define BOARD_INITBLEPINS_BT_REV_NAME                                   "BT_REV"   /*!< Identifier name */

/* PIO3_18 (coord M6), BLE reserved */
#define BOARD_INITBLEPINS_BT_REV1_GPIO                                      GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITBLEPINS_BT_REV1_PORT                                        3U   /*!< PORT device index: 3 */
#define BOARD_INITBLEPINS_BT_REV1_GPIO_PIN                                   18U   /*!< PIO3 pin index: 18 */
#define BOARD_INITBLEPINS_BT_REV1_PIN_NAME                               PIO3_18   /*!< Pin name */
#define BOARD_INITBLEPINS_BT_REV1_LABEL                           "BLE reserved"   /*!< Label */
#define BOARD_INITBLEPINS_BT_REV1_NAME                                 "BT_REV1"   /*!< Identifier name */
...
/* PIO1_17 (coord N12), Touchpanel int pin */
#define BOARD_INITTOUCHPANELPINS_TP_INT_GPIO                                GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITTOUCHPANELPINS_TP_INT_PORT                                  1U   /*!< PORT device index: 1 */
#define BOARD_INITTOUCHPANELPINS_TP_INT_GPIO_PIN                             17U   /*!< PIO1 pin index: 17 */
#define BOARD_INITTOUCHPANELPINS_TP_INT_PIN_NAME                         PIO1_17   /*!< Pin name */
#define BOARD_INITTOUCHPANELPINS_TP_INT_LABEL               "Touchpanel int pin"   /*!< Label */
#define BOARD_INITTOUCHPANELPINS_TP_INT_NAME                            "TP_INT"   /*!< Identifier name */

/* PIO2_27 (coord H14), Touchpanel reset pin */
#define BOARD_INITTOUCHPANELPINS_TP_RST_GPIO                                GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITTOUCHPANELPINS_TP_RST_PORT                                  2U   /*!< PORT device index: 2 */
#define BOARD_INITTOUCHPANELPINS_TP_RST_GPIO_PIN                             27U   /*!< PIO2 pin index: 27 */
#define BOARD_INITTOUCHPANELPINS_TP_RST_PIN_NAME                         PIO2_27   /*!< Pin name */
#define BOARD_INITTOUCHPANELPINS_TP_RST_LABEL             "Touchpanel reset pin"   /*!< Label */
#define BOARD_INITTOUCHPANELPINS_TP_RST_NAME                            "TP_RST"   /*!< Identifier name */
...
/* PIO2_2 (coord C3), Zigbee reset pin */
#define BOARD_INITZIGBEEPINS_ZB_RST_GPIO                                    GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITZIGBEEPINS_ZB_RST_PORT                                      2U   /*!< PORT device index: 2 */
#define BOARD_INITZIGBEEPINS_ZB_RST_GPIO_PIN                                  2U   /*!< PIO2 pin index: 2 */
#define BOARD_INITZIGBEEPINS_ZB_RST_PIN_NAME                              PIO2_2   /*!< Pin name */
#define BOARD_INITZIGBEEPINS_ZB_RST_LABEL                     "Zigbee reset pin"   /*!< Label */
#define BOARD_INITZIGBEEPINS_ZB_RST_NAME                                "ZB_RST"   /*!< Identifier name */

/* FC1_RXD_SDA_MOSI (coord B1), Zigbee uart rx */
#define BOARD_INITZIGBEEPINS_ZB_UART_RX_PERIPHERAL                     FLEXCOMM1   /*!< Device name: FLEXCOMM1 */
#define BOARD_INITZIGBEEPINS_ZB_UART_RX_SIGNAL                      RXD_SDA_MOSI   /*!< FLEXCOMM1 signal: RXD_SDA_MOSI */
#define BOARD_INITZIGBEEPINS_ZB_UART_RX_PIN_NAME                FC1_RXD_SDA_MOSI   /*!< Pin name */
#define BOARD_INITZIGBEEPINS_ZB_UART_RX_LABEL                   "Zigbee uart rx"   /*!< Label */
#define BOARD_INITZIGBEEPINS_ZB_UART_RX_NAME                        "ZB_UART_RX"   /*!< Identifier name */

/* FC1_TXD_SCL_MISO (coord D3), Zigbee uart tx */
#define BOARD_INITZIGBEEPINS_ZB_UART_TX_PERIPHERAL                     FLEXCOMM1   /*!< Device name: FLEXCOMM1 */
#define BOARD_INITZIGBEEPINS_ZB_UART_TX_SIGNAL                      TXD_SCL_MISO   /*!< FLEXCOMM1 signal: TXD_SCL_MISO */
#define BOARD_INITZIGBEEPINS_ZB_UART_TX_PIN_NAME                FC1_TXD_SCL_MISO   /*!< Pin name */
#define BOARD_INITZIGBEEPINS_ZB_UART_TX_LABEL                   "Zigbee uart tx"   /*!< Label */
#define BOARD_INITZIGBEEPINS_ZB_UART_TX_NAME                        "ZB_UART_TX"   /*!< Identifier name */

/* FC1_CTS_SDA_SSEL0 (coord C1), Zigbee uart cts */
#define BOARD_INITZIGBEEPINS_ZB_UART_CTS_PERIPHERAL                    FLEXCOMM1   /*!< Device name: FLEXCOMM1 */
#define BOARD_INITZIGBEEPINS_ZB_UART_CTS_SIGNAL                    CTS_SDA_SSEL0   /*!< FLEXCOMM1 signal: CTS_SDA_SSEL0 */
#define BOARD_INITZIGBEEPINS_ZB_UART_CTS_PIN_NAME              FC1_CTS_SDA_SSEL0   /*!< Pin name */
#define BOARD_INITZIGBEEPINS_ZB_UART_CTS_LABEL                 "Zigbee uart cts"   /*!< Label */
#define BOARD_INITZIGBEEPINS_ZB_UART_CTS_NAME                      "ZB_UART_CTS"   /*!< Identifier name */

/* FC1_RTS_SCL_SSEL1 (coord F3), Zigbee uart rts */
#define BOARD_INITZIGBEEPINS_ZB_UART_RTS_PERIPHERAL                    FLEXCOMM1   /*!< Device name: FLEXCOMM1 */
#define BOARD_INITZIGBEEPINS_ZB_UART_RTS_SIGNAL                    RTS_SCL_SSEL1   /*!< FLEXCOMM1 signal: RTS_SCL_SSEL1 */
#define BOARD_INITZIGBEEPINS_ZB_UART_RTS_PIN_NAME              FC1_RTS_SCL_SSEL1   /*!< Pin name */
#define BOARD_INITZIGBEEPINS_ZB_UART_RTS_LABEL                 "Zigbee uart rts"   /*!< Label */
#define BOARD_INITZIGBEEPINS_ZB_UART_RTS_NAME                      "ZB_UART_RTS"   /*!< Identifier name */

/* PIO2_10 (coord P1), Zigbee uart mode select */
#define BOARD_INITZIGBEEPINS_ZB_UART_MODE_GPIO                              GPIO   /*!< GPIO device name: GPIO */
#define BOARD_INITZIGBEEPINS_ZB_UART_MODE_PORT                                2U   /*!< PORT device index: 2 */
#define BOARD_INITZIGBEEPINS_ZB_UART_MODE_GPIO_PIN                           10U   /*!< PIO2 pin index: 10 */
#define BOARD_INITZIGBEEPINS_ZB_UART_MODE_PIN_NAME                       PIO2_10   /*!< Pin name */
#define BOARD_INITZIGBEEPINS_ZB_UART_MODE_LABEL        "Zigbee uart mode select"   /*!< Label */
#define BOARD_INITZIGBEEPINS_ZB_UART_MODE_NAME                    "ZB_UART_MODE"   /*!< Identifier name */
