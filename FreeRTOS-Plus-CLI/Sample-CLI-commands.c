...
static const CLI_Command_Definition_t xTestCmdLine =
{
		"test-cmd",
		"\r\ntest-cmd:\r\n Just a test for FreeRTOS-CLI by huang\r\n",
		prvTestCommand,
		0
};
...
void vRegisterSampleCLICommands( void )
{
	...
	FreeRTOS_CLIRegisterCommand( &xTestCmdLine );
...
static BaseType_t prvTestCommand( char *pcWriteBuffer, size_t xWriteBufferLen, const char *pcCommandString )
{
	const char *const testStr = " *********************************************\r\n FreeRTOS-CLI test-cmd return from LPC Succees!\r\n";
