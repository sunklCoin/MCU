...
#ifndef REMOTER_DMIC_H_
#define REMOTER_DMIC_H_
...
/* force to read the data in the first
 * g_Transfer_Done always false in the first time on this baseline,
